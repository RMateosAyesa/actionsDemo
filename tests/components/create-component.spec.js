...
describe("[Functional Test] Starter login", () => {
  ...
  test.describe("When I create a new component", () => {
    test("We should see the new component on the list", async () => {
      ...
      await componentsPage.verifyComponentIsCreated();
      await componentsPage.deleteComponent('QATestCompo');
    });
  });

  test.describe("When I enter invalid data for a new component", () => {
    test("We should see the error messages", async () => {
      await loginPage.login("managerqa", "managerqa");
      await loginPage.closeModalIfVisible();
      await loginPage.verifyLoginSuccess();
      ...
      await componentsPage.verifyErrorMessages();
    });
  });
